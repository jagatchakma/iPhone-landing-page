        ...
        <section className='h-full sm:py-32 py-20 sm:px-10 px-5 bg-zinc-900 relative overflow-hidden'>
            <div className='screen-max-width '>
                <div className='mb-12 w-full'>
                    <h1 id='features_title' className='text-gray-500 lg:text-6xl md:text-5xl text-3xl lg:mb-0 mb-5 font-medium opacity-0 translate-y-20'>Explore the full</h1>
                </div>
                <div className='flex flex-col justify-center items-center overflow-hidden'>
                    ...
                    <div className='flex flex-col items-center justify-center sm:px-10'>
                        <div className='relative h-[50vh] w-full flex items-center '>
                            <video src="" playsInline id='exploreVideo' className='w-full h-full object-cover object-center rounded-xl' preload='none' muted autoPlay ref={videoRef}>
