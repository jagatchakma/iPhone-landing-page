...
const HowItWorks = () => {
    ...
    return (
        <section className='sm:py-32 py-20 sm:px-10 px-5 overflow-hidden'>
            <div className='screen-max-width'>
                ...
                <div className='flex flex-col items-center'>
                    ...
                    <p className='text-gray-500 font-semibold text-xl md:text-2xl py-10 text-center'>It's here. The biggest redesing in the history of apple GPUs.</p>
                </div>
                <div className="mt-10 md:mt-20 mb-14">
                    <div className='relative h-full flex items-center justify-center'>
                        ...
                        <div className='absolute w-[95%] h-[90%] rounded-4xl  overflow-hidden'>
                            <video src="" className='pointer-events-none'
                                playsInline
                                preload='none'
                                muted
                                autoPlay
